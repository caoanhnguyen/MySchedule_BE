...
import com.example.myschedule.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OverlapRangeTimeException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleOverlapRangeTimeException(OverlapRangeTimeException ex, WebRequest request, Locale locale) {
    ...
    @ExceptionHandler(InvalidRangeTimeException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleInvalidRangeTimeException(InvalidRangeTimeException ex, WebRequest request, Locale locale) {
        String code = ex.getMessage() != null ? ex.getMessage() : "";
        String msg = messageSource.getMessage(code, null, code, locale);
        return ErrorResponse.builder()
                .timestamp(new Date())
